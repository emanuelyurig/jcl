...
/>
      ...
      {/* Mobile Nav */}
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-xl fixed inset-x-0 top-20 bottom-0 overflow-y-auto animate-in slide-in-from-right duration-300 z-50">
